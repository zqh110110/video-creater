...
class TianmuClient {
    ...
    async textToVideo(options) {
        ...
        return this.http.post('/v1/open/capacity/application/tm_text2video_b', payload);
    }
    /**
     * 图生视频
     */
    ...
    async textToSpeech(options) {
        ...
        return this.http.post('/v1/open/capacity/application/tm_text2speech_b', payload);
    }
    // ==================== 图像大模型 ====================
    /**
     * 文生图/参考生图
    ...
    async textToImage(options) {
        ...
        return this.http.post('/v1/open/capacity/application/tm_reference_img2img', payload);
    }
    /**
     * 参考生图
     */
    ...
    async getTaskStatus(task_id) {
        // 使用统一任务查询接口
        return this.http.post('/v1/open/pub/task', { task_id });
    }
    /**
     * 轮询任务直到完成
     */
